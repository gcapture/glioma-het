...
cellphonedb method statistical_analysis --pvalue=0.001 /scratch/devel/inmah/GLIOBLASTOMA/submission/CellPhoneDB/metadata_OPC_Oligo.txt  /scratch/devel/inmah/GLIOBLASTOMA/submission/CellPhoneDB/counts_OPC_Oligo.txt --counts-data=gene_name --iterations=1000 --threads=8 # because we use gene symbol 
