...
metadata <- metadata %>% 
            ...
            dplyr::mutate("snRNAseq" = factor(.data$snRNAseq, levels = c("Yes", "No")),
                          ...
                          "Diagnosis" = factor(.data$Diagnosis, levels = c("Astrocytoma", "Oligodendroglioma")),
...
```
<img src="../figs/Figure_1A/Figure_1A.png" class="mx-auto d-block" style="box-shadow: none; width: 100%"/>
