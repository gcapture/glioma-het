...
p1 <- SCpubr::do_NebulosaPlot(sample[, sample$subtype == "Astrocytoma"], 
                              ...
                              font.size = 12,
                              use_viridis = FALSE,
                              plot.title = "Pro Inflammatory TAMs | Astrocytoma",
...
p2 <- SCpubr::do_NebulosaPlot(sample[, sample$subtype == "Oligodendroglioma"], 
                              ...
                              font.size = 12,
                              use_viridis = FALSE,
                              plot.title = "Pro Inflammatory TAMs | Oligodendroglioma",
                              sequential.direction = 1) + ggplot2::theme(plot.title = ggplot2::element_text(face = "bold", hjust = 0.5))
...
#| eval: false
SCpubr::save_Plot(p,
                  figure_path = "/omics/odcf/analysis/OE0145_projects/idh_gliomas/Figures_Science/revision/IDH_gliomas_book/figs/Figure_S7C",
                  file_name = "Figure_S7C",
                  dpi = 300,
...
<img src="../figs/Figure_S7C/Figure_S7C.png" class="mx-auto d-block" style="box-shadow: none; width: 100%"/>